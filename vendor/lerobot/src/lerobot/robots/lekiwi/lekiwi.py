...
class LeKiwi(Robot):
    ...
    def configure(self):
        ...
        for name in self.base_motors:
            ...
            if self.config.base_wheel_torque_limit is not None:
                self.bus.write("Torque_Limit", name, self.config.base_wheel_torque_limit)
    ...
    def send_action(self, action: RobotAction) -> RobotAction:
        ...
        base_wheel_goal_vel = self._body_to_wheel_raw(
            ...
            max_raw=self.config.base_max_raw_velocity,
        )
