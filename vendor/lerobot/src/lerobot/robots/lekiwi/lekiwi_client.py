...
class LeKiwiClient(Robot):
    ...
    def __init__(self, config: LeKiwiClientConfig):
        ...
        self.speed_levels = [
            {"xy": config.slow_xy_speed, "theta": config.slow_theta_speed},
            {"xy": config.medium_xy_speed, "theta": config.medium_theta_speed},
            {"xy": config.fast_xy_speed, "theta": config.fast_theta_speed},
        ]
        self.speed_index = max(0, min(config.default_speed_index, len(self.speed_levels) - 1))
